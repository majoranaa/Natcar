...
#define MAX_SPEED    150    // Maximum speed (0-255) that car can go
#define MIN_SPEED    110    // Minimum speed (0-255) that car can go
...
#define NUM_STOP     25     // Cycles to stop for each time; appx 100 cycles per second
