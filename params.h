...
#define MAX_SPEED    220    // Maximum speed (0-255) that car can go
#define MIN_SPEED    150    // Minimum speed (0-255) that car can go
...
#define ERR_THRESH   20
#define NUM_STOP     3     // Cycles to stop for each time
#define MAX_WEIGHT   .2     // Weight to put on MAX_SPEED when calculating speed threshold for fast stop
